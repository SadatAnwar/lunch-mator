...
object GoogleModels {
  ...
  case class GoogleUserInformation(iss: String, aud: String, sub: String, hd: Option[String], email: String, name: String, picture: String, given_name: String, family_name: String)
